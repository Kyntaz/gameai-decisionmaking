...
namespace Assets.Scripts
{
    public class AutonomousCharacter : MonoBehaviour
    {
        ...
        public void Awake()
        {
			...
			this.Mcts = new MCTSLimitedPlayout(worldModel);
		...
		private void UpdateMCTS()
		{
			...
			this.BestDiscontentmentText.text = "Max Playout Depth: " + this.Mcts.MaxPlayoutDepthReached.ToString("F");
			this.ProcessedActionsText.text = "Max Selection Depth: " + this.Mcts.MaxSelectionDepthReached.ToString("F");
